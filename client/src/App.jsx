...
const PROVIDERS = {
  ...
  xai:         { label: "xAI (Grok)",  color: "#000000", logo: "✕" },
  qwen:        { label: "Qwen",        color: "#6200ff", logo: "◈" },
...
function ApiKeysPage() {
  ...
  const keyDefs = [
    ...
    { id:"XAI_API_KEY",        label:"xAI (Grok)",         logo:"✕", color:"#ffffff", hint:"xai-..." },
    { id:"QWEN_API_KEY",       label:"Qwen (Alibaba)",     logo:"◈", color:"#6200ff", hint:"sk-..." },
